...
![SQLite](https://img.shields/badge/SQLite-Persistent%20Storage-blue)  
![CLI](https://img.shields.io/badge/CLI-Tool-yellow)
...
### 🔁 Fault Tolerance  
Exponential-backoff retrying and Dead Letter Queue (DLQ) ensure resilient execution.
